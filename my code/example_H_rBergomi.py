...
deepsignet_transformer_1 = models.deepsignet_transformer_1(augment_include_original=True, augment_include_time=True, T=1)
model_trainer(deepsignet_transformer_1, 'SigFormer_1', history)
print('******SigFormer_1训练完成******')

print('******开始训练SigFormer_2******')
deepsignet_transformer_2 = models.deepsignet_transformer_2(augment_include_original=True, augment_include_time=True, T=1)
model_trainer(deepsignet_transformer_2, 'SigFormer_2', history)
print('******SigFormer_2训练完成******')

print('******开始训练SigFormer_3******')
deepsignet_transformer_3 = models.deepsignet_transformer_3(augment_include_time=True, T=1)
model_trainer(deepsignet_transformer_3, 'SigFormer_3', history)
...
'''输出训练结果'''
params = {}
for i, j in zip(('My_DeepSigNet', 'CNN', 'SigFormer_1', 'SigFormer_2',  'SigFormer_3'),
                (my_deepsignet, cnn, deepsignet_transformer_1, deepsignet_transformer_2, deepsignet_transformer_3)):
...
for k in ('My_DeepSigNet', 'CNN', 'SigFormer_1', 'SigFormer_2',  'SigFormer_3'):
...
plt.savefig('data/example_H_rBergomi/rBergomi_grid=100_Hbeta_eta=1_v0=0.01.eps', bbox_inches='tight')
