...
kappas=np.around(np.linspace(0.1, 0.5, 10), decimals=2).tolist()
...
history = {}
x_train, y_train, x_test, y_test = rHeston_fast.generate_data(n_paths_train, n_paths_test, n_samples, kappas=kappas, alphas=alphas)
...
plt.savefig('C:\CodeFiles\PythonFiles\PythonProjects\signature_transformer_2023\example_rHeston_parameters\data\example_rHeston_parameters.eps'
            , bbox_inches='tight')
