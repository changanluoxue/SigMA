...
volatility_model = 'rHeston' #'rBergomi', 'rHeston'

'''导入数据集'''
X_train = np.load(f'data/simulated_data/{volatility_model}/Xtrain_grid={input_length}_{H_distribution}_kappa1uniform_kappa2uniform_thetauniform_v0=0.01.npy')
Y_train = np.load(f'data/simulated_data/{volatility_model}/Ytrain_grid={input_length}_{H_distribution}_kappa1uniform_kappa2uniform_thetauniform_v0=0.01.npy')
X_eval = np.load(f'data/simulated_data/{volatility_model}/Xeval_grid={input_length}_{H_distribution}_kappa1uniform_kappa2uniform_thetauniform_v0=0.01.npy')
Y_eval = np.load(f'data/simulated_data/{volatility_model}/Yeval_grid={input_length}_{H_distribution}_kappa1uniform_kappa2uniform_thetauniform_v0=0.01.npy')
...
transformer = models_rHeston.transformer(augment_include_original=True, augment_include_time=True, T=1)
...
print('******开始训练SigMA******')
sigma = models_rHeston.sigma(augment_include_original=True, augment_include_time=True, T=1)
...
deepsignet = models_rHeston.deepsignet(augment_include_original=True, augment_include_time=True, T=1)
...
plt.savefig(f'data/results/multiple_{volatility_model}/{volatility_model}_grid={input_length}_{H_distribution}_kappa1uniform_kappa2uniform_thetauniform_v0=0.01_round{round}.eps', bbox_inches='tight')
