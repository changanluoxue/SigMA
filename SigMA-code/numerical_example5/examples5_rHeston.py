...
torch.save(sigma, 'data/results/multiple_rHeston/trained_models/sigma.pth')
print('******SigMA训练完成******')
...
'''输出训练结果'''
params = {}
for i, j in zip(('Transformer', 'SigMA', 'DeepSigNet', 'CNN'),
                (transformer, sigma, deepsignet, cnn)):
...
for k in ('Transformer', 'SigMA', 'DeepSigNet', 'CNN'):
