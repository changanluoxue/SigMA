...
torch.save(sigma_stride1, 'data/results/input_length_100/fBm/trained_models/sigma_stride1.pth')
...
torch.save(sigma_stride10, 'data/results/input_length_100/fBm/trained_models/sigma_stride10.pth')
...
torch.save(sigma_stride50, 'data/results/input_length_100/fBm/trained_models/sigma_stride50.pth')
...
# plt.savefig('data/results/input_length_100/fBm/fBm_grid=100_Huniform_round3.eps', bbox_inches='tight')
plt.savefig('data/results/input_length_100/fBm/fBm_grid=100_Hbeta_round3.eps', bbox_inches='tight')
