...
torch.save(sigma_stride50, 'data/results/input_length_1500/fBm/trained_models/sigma_stride50.pth')
...
torch.save(sigma_stridehalf, 'data/results/input_length_1500/fBm/trained_models/sigma_stride750.pth')
...
# plt.savefig('data/results/input_length_1500/fBm/fBm_grid=1500_Huniform_round1.eps', bbox_inches='tight')
