...
torch.save(sigma_stride50, 'data/results/input_length_1500/rBergomi/trained_models/sigma_stride50.pth')
...
torch.save(sigma_stridehalf, 'data/results/input_length_1500/rBergomi/trained_models/sigma_stride750.pth')
...
# plt.savefig('data/results/input_length_1500/rBergomi/rBergomi_grid=1500_Huniform_eta=1_v0=0.01_round1.eps', bbox_inches='tight')
