...
class cnn(nn.Module):
    def __init__(self):
        ...
        '(time_grid, in_features): (100,384), (500,2304), (1000,4736), (1500,7040)'
...
class transformer(nn.Module):
    def __init__(self, augment_include_original=True, augment_include_time=True, T=1):
        ...
        self.attention = layers.MultiHeadAttention(d_k=[5, 25, 125], in_features=[5, 25, 125], heads=3, out_features=155)
        '(time_grid, in_features): (100,15500), (500,77500)'
...
class lstm(nn.Module):
    def __init__(self):
        ...
        '(time_grids, input_size): (100, 12672), (500, 63872), (1000, 127872), (1500, 191872)'
