...
# torch.save(transformer, 'data/results/input_length_500/fBm/trained_models/Transformer.pth')
...
torch.save(sigma, 'data/results/input_length_1500/fBm/trained_models/SigMA.pth')
print('******SigMA训练完成******')
...
torch.save(deepsignet, 'data/results/input_length_1500/fBm/trained_models/DeepSigNet.pth')
print('******DeepSigNet训练完成******')

print('******开始训练CNN******')
cnn = models.cnn()
model_trainer(cnn, 'CNN', history)
torch.save(cnn, 'data/results/input_length_1500/fBm/trained_models/CNN.pth')
print('******CNN训练完成******')
...
plt.savefig('data/results/input_length_1500/fBm/fBm_grid=1500_Hbeta_round1.eps', bbox_inches='tight')
