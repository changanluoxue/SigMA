...
torch.save(sigma_1, 'data/results/input_length_1500/rHeston/trained_models/SigMA_1.pth')
print('******SigMA_1训练完成******')
...
torch.save(sigma_2, 'data/results/input_length_1500/rHeston/trained_models/SigMA_2.pth')
print('******SigMA_2训练完成******')

print('******开始训练SigMA_3******')
sigma_3 = models.sigma_3(augment_include_time=True, T=1)
model_trainer(sigma_3, r'$\rm SigMA\,without\,CNN\,or\,MLP$', history)
torch.save(sigma_3, 'data/results/input_length_1500/rHeston/trained_models/SigMA_3.pth')
print('******SigMA_3训练完成******')
