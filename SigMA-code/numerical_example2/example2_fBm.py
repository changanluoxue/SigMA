...
'''导入数据集'''
# X_train = np.load('data/simulated_data/fBm/Xtrain_grid=500_Huniform.npy')
# Y_train = np.load('data/simulated_data/fBm/Ytrain_grid=500_Huniform.npy')
# X_eval = np.load('data/simulated_data/fBm/Xeval_grid=500_Huniform.npy')
# Y_eval = np.load('data/simulated_data/fBm/Yeval_grid=500_Huniform.npy')

X_train = np.load('data/simulated_data/fBm/Xtrain_grid=500_Hbeta.npy')
Y_train = np.load('data/simulated_data/fBm/Ytrain_grid=500_Hbeta.npy')
X_eval = np.load('data/simulated_data/fBm/Xeval_grid=500_Hbeta.npy')
Y_eval = np.load('data/simulated_data/fBm/Yeval_grid=500_Hbeta.npy')
...
torch.save(deepsignet, 'data/results/Trun_5/input_length_500/fBm/trained_models/DeepSigNet.pth')
...
torch.save(sigma, 'data/results/Trun_5/input_length_500/fBm/trained_models/SigMA.pth')
print('******SigMA训练完成******')

print('******开始训练SigSA******')
sigsa = models.sigsa(augment_include_time=True, T=1)
model_trainer(sigsa, 'SigSA', history)
torch.save(sigsa, 'data/results/Trun_5/input_length_500/fBm/trained_models/SigSA.pth')
print('******SigSA训练完成******')
...
# plt.savefig('data/results/Trun_5/input_length_500/fBm/fBm_grid=500_Huniform_Trun5_round1.eps', bbox_inches='tight')
plt.savefig('data/results/Trun_5/input_length_500/fBm/fBm_grid=500_Hbeta_Trun5_round3.eps', bbox_inches='tight')
