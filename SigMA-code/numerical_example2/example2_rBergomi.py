...
'''导入数据集'''
# X_train = np.load('data/simulated_data/rBergomi/Xtrain_grid=500_Huniform_eta=1_v0=0.01.npy')
# Y_train = np.load('data/simulated_data/rBergomi/Ytrain_grid=500_Huniform_eta=1_v0=0.01.npy')
# X_eval = np.load('data/simulated_data/rBergomi/Xeval_grid=500_Huniform_eta=1_v0=0.01.npy')
# Y_eval = np.load('data/simulated_data/rBergomi/Yeval_grid=500_Huniform_eta=1_v0=0.01.npy')
...
torch.save(deepsignet, 'data/results/Trun_5/input_length_500/rBergomi/trained_models/DeepSigNet.pth')
...
torch.save(sigma, 'data/results/Trun_5/input_length_500/rBergomi/trained_models/SigMA.pth')
print('******SigMA训练完成******')

print('******开始训练SigSA******')
sigsa = models.sigsa(augment_include_time=True, T=1)
model_trainer(sigsa, 'SigSA', history)
torch.save(sigsa, 'data/results/Trun_5/input_length_500/rBergomi/trained_models/SigSA.pth')
print('******SigSA训练完成******')
...
# plt.savefig('data/results/Trun_5/input_length_500/rBergomi/rBergomi_grid=500_Huniform_eta=1_v0=0.01_Trun5_round1.eps', bbox_inches='tight')
plt.savefig('data/results/Trun_5/input_length_500/rBergomi/rBergomi_grid=500_Hbeta_eta=1_v0=0.01_Trun5_round3.eps', bbox_inches='tight')
