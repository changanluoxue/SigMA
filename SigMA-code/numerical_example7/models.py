...
class cnn(nn.Module):
    def __init__(self):
        ...
        '(time_grid, in_features): (50,128), (100,384), (500,2304), (1000,4736), (1500,7040)'
...
class sigma(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.augment_include_time is True:
            x = torch.cat((x, time), dim=1)
        x = torch.transpose(x, 1, 2)
        '(input_length, stride): (50,25), (100,50), (500,250), (1000,500), (1500,750)'
...
class transformer(nn.Module):
    def __init__(self, augment_include_original=True, augment_include_time=True, T=1):
        ...
        self.attention = layers.MultiHeadAttention(d_k=[5, 25, 125], in_features=[5, 25, 125], heads=3, out_features=155)
        '(time_grid, in_features): (50,7750), (100,15500), (500,77500)'
...
class lstm(nn.Module):
    def __init__(self):
        ...
        '(time_grids, input_size): (50,6272), (100,12672), (500,63872), (1000,127872), (1500,191872)'
        self.dense = fnn(input_size=12672, hidden_sizes=(128, 64), output_size=1, activation=nn.PReLU())
        self.flatten = nn.Flatten(start_dim=1, end_dim=-1)
