...
history = {}
x_train, y_train, x_test, y_test = hurst_parameter.generate_data(n_paths_train, n_paths_test,
...
(train_dataloader, test_dataloader,
 example_batch_x, example_batch_y) = hurst_parameter.generate_torch_batched_data(x_train_, y_train,
                                                                                 x_test_, y_test,
...
plt.savefig('C:\CodeFiles\PythonFiles\PythonProjects\signature_transformer_2023\Reproduce\data\example_hurst_parameter.eps'
            , bbox_inches='tight')
