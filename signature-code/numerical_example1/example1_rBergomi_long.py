...
torch.save(sigformer_stride50, 'data/results/input_length_1500/rBergomi/trained_models/sigformer_stride50.pth')
...
torch.save(sigformer_stridehalf, 'data/results/input_length_1500/rBergomi/trained_models/sigformer_stride750.pth')
