...
# plt.savefig('data/results/rBergomi_grid=100_Huniform_eta=1_v0=0.01_round3.eps', bbox_inches='tight')
plt.savefig('data/results/rBergomi_grid=100_Hbeta_eta=1_v0=0.01_round3.eps', bbox_inches='tight')
