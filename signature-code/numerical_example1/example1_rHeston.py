...
# plt.savefig('data/results/rHeston_grid=100_Huniform_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_round3.eps', bbox_inches='tight')
plt.savefig('data/results/rHeston_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_round3.eps', bbox_inches='tight')
