...
torch.save(sigformer_stride1, 'data/results/input_length_100/fBm/trained_models/sigformer_stride1.pth')
...
torch.save(sigformer_stride10, 'data/results/input_length_100/fBm/trained_models/sigformer_stride10.pth')
...
torch.save(sigformer_stride50, 'data/results/input_length_100/fBm/trained_models/sigformer_stride50.pth')
