...
if __name__ == "__main__":
    ...
    V_0 = 0.01; eta = 1
    reps = 1e-6; kappa_1 = 0.1; kappa_2 = 0.03; theta = 0.3# rHeston的参数
    # X_train, Y_train, X_eval, Y_eval = generate_fBm_paths(n_paths_train, n_paths_eval, grid_points, Hs_beta, T)
    # X_train, Y_train, X_eval, Y_eval = generate_rBergomi_paths(n_paths_train, n_paths_eval, grid_points, Hs_beta, T, etas_uniform, V_0)
    X_train, Y_train, X_eval, Y_eval = generate_rHeston_paths(n_paths_train, n_paths_eval, grid_points, T, V_0, reps, Hs_beta, kappa1s_uniform, kappa2s_uniform, thetas_uniform)
    np.save('data/simulated_data/rHeston/Xtrain_grid=100_Hbeta_kappa1uniform_kappa2uniform_thetauniform_v0=0.01', X_train)
    np.save('data/simulated_data/rHeston/Ytrain_grid=100_Hbeta_kappa1uniform_kappa2uniform_thetauniform_v0=0.01', Y_train)
    np.save('data/simulated_data/rHeston/Xeval_grid=100_Hbeta_kappa1uniform_kappa2uniform_thetauniform_v0=0.01', X_eval)
    np.save('data/simulated_data/rHeston/Yeval_grid=100_Hbeta_kappa1uniform_kappa2uniform_thetauniform_v0=0.01', Y_eval)

import pygame
import time
def play_music():
    pygame.init()
    pygame.mixer.music.load("C:/Users/wxl15/Desktop/naozhong.mp3")  # 替换为你的音乐文件路径
    pygame.mixer.music.play()
    time.sleep(5)  # 等待音乐播放完成，可以根据实际情况调整时间
    pygame.mixer.music.stop()
play_music()# 在代码结束处调用播放音乐的函数