...
torch.save(deepsignet, 'data/results/Trun_1/input_length_100/rHeston/trained_models/DeepSigNet.pth')
...
torch.save(sigformer, 'data/results/Trun_1/input_length_100/rHeston/trained_models/SigFormer.pth')
print('******SigFormer训练完成******')
...
torch.save(sigformer_s, 'data/results/Trun_1/input_length_100/rHeston/trained_models/SigFormer_s.pth')
...
# plt.savefig('data/results/Trun_1/input_length_100/rHeston/rHeston_grid=100_Huniform_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_Trun1_round1.eps', bbox_inches='tight')
plt.savefig('data/results/Trun_1/input_length_100/rHeston/rHeston_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_Trun1_round1.eps', bbox_inches='tight')
