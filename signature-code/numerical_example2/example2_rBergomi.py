...
torch.save(deepsignet, 'data/results/Trun_1/input_length_100/rBergomi/trained_models/DeepSigNet.pth')
...
torch.save(sigformer, 'data/results/Trun_1/input_length_100/rBergomi/trained_models/SigFormer.pth')
print('******SigFormer训练完成******')
...
torch.save(sigformer_s, 'data/results/Trun_1/input_length_100/rBergomi/trained_models/SigFormer_s.pth')
...
# plt.savefig('data/results/Trun_1/input_length_100/rBergomi/rBergomi_grid=100_Huniform_eta=1_v0=0.01_Trun1_round1.eps', bbox_inches='tight')
plt.savefig('data/results/Trun_1/input_length_100/rBergomi/rBergomi_grid=100_Hbeta_eta=1_v0=0.01_Trun1_round1.eps', bbox_inches='tight')
