...
'''导入数据集'''
X_train = np.load('data/simulated_data/rHeston/Xtrain_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_thetauniform_v0=0.01.npy')
Y_train = np.load('data/simulated_data/rHeston/Ytrain_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_thetauniform_v0=0.01.npy')
X_eval = np.load('data/simulated_data/rHeston/Xeval_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_thetauniform_v0=0.01.npy')
Y_eval = np.load('data/simulated_data/rHeston/Yeval_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_thetauniform_v0=0.01.npy')
...
sigformer_1 = models_B.sigformer_1(augment_include_time=True, T=1)
model_trainer(sigformer_1, r'$\rm SigFormer\,without\,CNN$', history)
print('******SigFormer_1训练完成******')

print('******开始训练SigFormer_2******')
sigformer_2 = models_B.sigformer_2(augment_include_original=True, augment_include_time=True, T=1)
model_trainer(sigformer_2, r'$\rm SigFormer\,without\,MLP$', history)
print('******SigFormer_2训练完成******')

print('******开始训练SigFormer_3******')
sigformer_3 = models_B.sigformer_3(augment_include_time=True, T=1)
model_trainer(sigformer_3, r'$\rm SigFormer\,without\,CNN\,or\,MLP$', history)
print('******SigFormer_3训练完成******')

print('******开始训练SigFormer******')
sigformer = models_B.sigformer(augment_include_original=True, augment_include_time=True, T=1)
model_trainer(sigformer, 'SigFormer', history)
print('******SigFormer训练完成******')

print('******开始训练SigFormer_s******')
sigformer_s = models_B.sigformer_s(augment_include_time=True, T=1)
...
plt.savefig('data/results/rHeston_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_thetauniform_v0=0.01_round3.eps', bbox_inches='tight')
