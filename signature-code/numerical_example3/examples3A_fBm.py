...
'''导入数据集'''
# X_train = np.load('data/simulated_data/fBm/Xtrain_grid=300_Huniform.npy')
# Y_train = np.load('data/simulated_data/fBm/Ytrain_grid=300_Huniform.npy')
# X_eval = np.load('data/simulated_data/fBm/Xeval_grid=300_Huniform.npy')
# Y_eval = np.load('data/simulated_data/fBm/Yeval_grid=300_Huniform.npy')
...
# plt.savefig('data/results/fBm_grid=300_Huniform_round3.eps', bbox_inches='tight')
