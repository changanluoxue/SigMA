...
torch.save(sigformer_1, 'data/results/input_length_1500/rBergomi/trained_models/SigFormer_1.pth')
...
torch.save(sigformer_2, 'data/results/input_length_1500/rBergomi/trained_models/SigFormer_2.pth')
...
torch.save(sigformer_3, 'data/results/input_length_1500/rBergomi/trained_models/SigFormer_3.pth')
