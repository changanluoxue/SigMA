...
transformer = models_B.transformer(augment_include_original=True, augment_include_time=True, T=1)
...
deepsignet = models_B.deepsignet(augment_include_original=True, augment_include_time=True, T=1)
...
plt.savefig('data/results/rHeston_grid=100_Hbeta_kappa1uniform_kappa2uniform_thetauniform_v0=0.01_round3.eps', bbox_inches='tight')
