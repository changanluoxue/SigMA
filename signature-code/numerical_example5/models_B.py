...
class cnn(nn.Module):
    def __init__(self):
        ...
        # (time_grid, in_features): (100,384), (500,2304)
...
class sigformer(nn.Module):
    def __init__(self, augment_include_original=True, augment_include_time=True, T=1):
        ...
        # (time_grid, in_features): (100,310), (500,1550)
        ...
        self.linear_layer.weight.data = torch.tensor([[1,0,0,0], [0,3,0,0], [0,0,5,0], [0,0,0,0.5]], dtype=torch.float32)
