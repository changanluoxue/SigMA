...
X_train = np.load('data/simulated_data/fBm/Xtrain_grid=300_Hbeta.npy')
Y_train = np.load('data/simulated_data/fBm/Ytrain_grid=300_Hbeta.npy')
X_eval = np.load('data/simulated_data/fBm/Xeval_grid=300_Hbeta.npy')
Y_eval = np.load('data/simulated_data/fBm/Yeval_grid=300_Hbeta.npy')
...
# plt.savefig('data/results/fBm_grid=500_Huniform_round3.eps', bbox_inches='tight')
plt.savefig('data/results/fBm_grid=300_Hbeta_round3.eps', bbox_inches='tight')
