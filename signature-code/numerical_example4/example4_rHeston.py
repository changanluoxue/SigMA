...
X_train = np.load('data/simulated_data/rHeston/Xtrain_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
Y_train = np.load('data/simulated_data/rHeston/Ytrain_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
X_eval = np.load('data/simulated_data/rHeston/Xeval_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
Y_eval = np.load('data/simulated_data/rHeston/Yeval_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
...
'''输出训练结果'''
params = {}
for i, j in zip(('Transformer', 'SigFormer', 'DeepSigNet', 'CNN'),
                (transformer, sigformer, deepsignet, cnn)):
...
for k in ('Transformer', 'SigFormer', 'DeepSigNet', 'CNN'):
...
# plt.savefig('data/results/rHeston_grid=500_Huniform_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_round3.eps', bbox_inches='tight')
plt.savefig('data/results/rHeston_grid=300_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_round3.eps', bbox_inches='tight')
