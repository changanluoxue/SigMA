...
class cnn(nn.Module):
    def __init__(self):
        ...
        self.dense1 = nn.Linear(in_features=1408, out_features=128)
...
class sigformer(nn.Module):
    def __init__(self, augment_include_original=True, augment_include_time=True, T=1):
        ...
        # (time_grid, in_features): (100,310), (200,620), (300,930), (400,1240), (500,1550)
...
class transformer(nn.Module):
    def __init__(self, augment_include_original=True, augment_include_time=True, T=1):
        ...
        self.attention = layers.MultiHeadAttention(d_k=[5, 25, 125], in_features=[5, 25, 125], heads=3, out_features=155)
        # (time_grid, in_features): (100,15500), (200,31000), (300,46500), (400,62000), (500,77500)
        self.dense = fnn(input_size=46500, hidden_sizes=(32, 32, 32, 32, 32), output_size=1, activation=nn.ReLU())
        self.sigmoid = nn.Sigmoid()
        self.flatten = nn.Flatten(start_dim=1, end_dim=-1)
